...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModule(int steerNum, int driveNum, boolean invertDrive, boolean invertSteer, int analogNum,
      shuffleBoardDrive drivePos) {
  ...
  public boolean getSteerPIDAtSetpoint() {
    return this.steerPID.atSetpoint();
  }
